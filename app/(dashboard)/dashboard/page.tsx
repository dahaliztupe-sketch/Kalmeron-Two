...
export default function DashboardPage() {
  // Using use() API as requested for React 19 data fetching
  const userData = use(getUserData());
  const initialInsight = use(getProactiveWarnings("general"));
      ...
      <main className="flex-1 mr-64 p-8 relative">
        ...
        <BentoGrid>
          ...
          <BentoCard span={2} className="p-6">
            ...
            <p className="text-neutral-400 mb-6">متتبع المراحل: <span className="text-[#D4AF37]">{userData.stage}</span></p>
          ...
          <BentoCard span={1} className="p-6 flex flex-col justify-center items-center text-center">
            ...
            <p className="text-sm text-neutral-400 line-clamp-3">{initialInsight || "احرص دائمًا على توثيق مستنداتك القانونية بشكل مسبق."}</p>
          </BentoCard>
