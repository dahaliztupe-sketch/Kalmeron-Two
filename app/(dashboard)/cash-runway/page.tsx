      ...
      <div dir="rtl" className="max-w-3xl mx-auto">
        ...
        {!hasSnapshot && (
          <motion.div
            ...
            className="mb-5 rounded-2xl border border-cyan-500/25 bg-cyan-500/[0.06] px-5 py-4 space-y-3"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-white mb-0.5">أدخل بياناتك المالية</p>
                <p className="text-xs text-text-secondary leading-relaxed">
                  أدخل السيولة الحالية والإيرادات والمصروفات الشهرية لحساب مدرجك الزمني وتلقّي تنبيهات مبكرة.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-2 pr-14">
              <a
                href="#runway-inputs"
                className="inline-flex items-center gap-2 text-xs font-semibold text-white bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/30 px-4 py-2 rounded-xl transition-all"
              >
                <Calculator className="w-3.5 h-3.5" /> احسب مدرجك الآن
              </a>
              <Link
                href="/chat?q=كيف أحسب مدرج السيولة لشركتي الناشئة؟"
                className="inline-flex items-center gap-2 text-xs text-neutral-400 hover:text-white border border-white/10 hover:border-white/20 px-4 py-2 rounded-xl transition-all"
              >
                اسأل CFO
              </Link>
            </div>
