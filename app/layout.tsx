...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "نظام تشغيل المؤسسين — سبعة أقسام تشغيلية مترابطة في منصة واحدة. تحليل السوق، النمذجة المالية، التأسيس القانوني، والتخطيط الاستراتيجي — كل شيء في مكان واحد.",
    keywords: [
    ...
    openGraph: {
      ...
      description: "سبعة أقسام تشغيلية مترابطة في منصة واحدة — يثق فيه +٣٢٠٠ مؤسس في ١٥ دولة.",
      images: [
        {
    ...
    twitter: {
      ...
      title: "كلميرون — ٥٧ مساعداً ذكياً للمؤسّس العربي",
      description: "نظام تشغيل المؤسسين — سبعة أقسام تشغيلية مترابطة في منصة واحدة.",
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "description": "نظام تشغيل المؤسسين — منصة موحّدة للمالية، القانون، التسويق، المبيعات، الموارد البشرية، والعمليات.",
      "foundingLocation": {
        "@type": "Place",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "كلميرون هو نظام تشغيل للمؤسّس يضمّ سبعة أقسام تشغيلية مترابطة — المالية، القانون، التسويق، المبيعات، الموارد البشرية، العمليات، والاستراتيجية — مصمّم للسوق المصري والخليجي.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "نعم، كلميرون يدعم العربية والإنجليزية. يفهم السياق المصري والخليجي ويردّ بأسلوب طبيعي يعكس بيئة السوق المحلي.",
          },
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "كلميرون مبني خصيصاً للمؤسسين، بعكس ChatGPT العام. يضمّ سبعة أقسام تشغيلية متخصصة في ريادة الأعمال، قانون الشركات، والنمذجة المالية — منصة متخصصة لا أداة عامة.",
          },
        },
      ],
    },
