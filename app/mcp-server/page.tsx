...
export default function McpServerPage() {
  return (
    <SeoLandingShell
      ...
      description="استخدم ٥٧ مساعداً ذكياً عربياً مباشرة من Claude Desktop، Cursor، Continue، VSCode، وأي MCP client. الـ AI الخاص بك يصبح متخصصاً في السوق العربي."
    ...
    >
      <section className="grid md:grid-cols-2 gap-6 mb-16">
        {[
          ...
          { icon: Cpu, title: "57 Tools", desc: "كل مساعد من كلميرون متاح كـ MCP tool: legal، finance، marketing، إلخ." },
