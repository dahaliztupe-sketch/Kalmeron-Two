  ...
  return (
    <AppShell>
      <div className="p-6 md:p-8 max-w-6xl mx-auto" dir="rtl">
        ...
        {suggestedPrompt && (
          <div className="mb-5 rounded-2xl border border-cyan-500/25 bg-cyan-500/[0.06] px-5 py-4 flex items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/15 flex items-center justify-center shrink-0">
              <Zap className="w-5 h-5 text-cyan-400" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white mb-1">إجراء تشغيلي مقترح</p>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-3 text-xs font-semibold text-white bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/30 px-4 py-2 rounded-xl transition-all"
              >
                <Zap className="w-3.5 h-3.5" /> ابدأ مع كلميرون
              </Link>
            </div>
          </div>
        )}
