...
export async function GET() {
  ...
  lines.push('');
  lines.push('> نظام تشغيل ذكي لرواد الأعمال في المنطقة العربية، يضم أكثر من 50 وكيلاً متخصصاً يعملون كفريق التأسيس الخاص بك.');
  lines.push('');
  lines.push(
    'Kalmeron AI is an Arabic-first AI studio for entrepreneurs in MENA. It bundles 50+ specialized agents (CFO, legal advisor, marketing manager, opportunity radar, mistake shield, etc.) trained on the Egyptian and Gulf markets.'
  );
  lines.push('');
