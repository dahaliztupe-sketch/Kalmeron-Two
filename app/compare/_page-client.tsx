...
const ROWS: ComparisonRow[] = [
  ...
  { category: "الذكاء الاصطناعي", feature: "٥٧ مساعداً ذكياً متخصصاً عبر ٧ أقسام", kalmeron: true, consultants: false, chatgpt: false, notion: false, note: "كلميرون وحده يقدم هذا المستوى من التخصص" },
