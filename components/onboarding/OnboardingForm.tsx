...
const GOAL_MISSIONS: Record<string, GoalMissionBase> = {
  idea_analysis: {
    ...
    baseHref: "/chat?q=",
    chatPromptByStage: {
      idea:       "حلّل فكرة مشروعي وقيّم جدواها في السوق المصري — أحتاج تحليل SWOT وتقييم المخاطر",
      validation: "أنا في مرحلة اختبار السوق — حلّل نتائجي وساعدني على تطوير الفكرة بناءً على feedback العملاء",
      mvp:        "عندي MVP جاهز — حلّل موقعي التنافسي وجدوى التوسع قبل إطلاق المنتج رسمياً",
      foundation: "شركتي قائمة — قيّم موقفي الاستراتيجي وأعطني خريطة طريق للنمو في السوق المصري",
      growth:     "شركتي في مرحلة النمو — حلّل فرص التوسع الجديدة وقيّم جاهزيتنا للدخول في أسواق إضافية",
    },
  ...
  market: {
    ...
    chatPromptByStage: {
      ...
      mvp:        "أريد تحليل السوق المستهدف لمنتجي الأولي: الجمهور، القنوات، والتسعير المناسب",
      foundation: "أجرِ تحليلاً للمنافسين وحدّد فرص النمو غير المستغلة في سوقنا",
      growth:     "أريد تحليل أسواق التوسع الجديدة: تقييم الجاهزية، المخاطر، وأولويات الدخول",
    },
  ...
  legal: {
    ...
    chatPromptByStage: {
      ...
      mvp:        "أريد تأسيس شركتي رسمياً — اشرح لي خطوات التأسيس والتراخيص المطلوبة في مصر",
      foundation: "شركتي مؤسسة — راجع هيكلي القانوني وأنصحني بأفضل حماية لملكيتي الفكرية والعقود",
      growth:     "شركتي تتوسع — ما المتطلبات القانونية للتوسع في أسواق جديدة أو إضافة مستثمرين؟",
    },
              ...
              {step === 0 && (
                <div className="text-center space-y-5">
                  ...
                  <div className="space-y-2.5 text-sm text-neutral-300">
                    {[
                      { icon: "🤖", text: "٥٧ متخصصاً في ٧ أقسام تشغيلية" },
