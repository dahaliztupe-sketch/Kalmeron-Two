...
const INJECTION_PATTERNS: readonly InjectionPattern[] = [
  ...
  { name: 'ar_no_filter',
    regex: /(?:(?:رد|جواب|إجابة|أجب|تكلم|تحدث)\s+(?:بدون|دون|بلا|من\s+غير)\s+(?:قيود|رقابة|فلتر|حدود|قواعد|أخلاق|ضوابط))|(?:(?:بدون|دون|بلا|من\s+غير)\s+(?:فلتر|رقابة|ضوابط\s+الذكاء|قيود\s+الذكاء|أخلاقيات\s+الذكاء))/i,
    weight: 0.9 },
  { name: 'ar_stop_being',
