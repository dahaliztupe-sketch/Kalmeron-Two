...
function buildRecommendations(
  ...
  if (status === "warning") {
    return [
      "⚠️ تنبيه — تبقّى لك أقلّ من 6 أشهر. ابدأ التحرّك الآن قبل أن يتحوّل الوضع لحرج.",
      `راجع كل اشتراك SaaS — احذف أي اشتراك لم يُستخدم في آخر 30 يوماً.`,
      `ابدأ محادثات تمويل الآن — جولة pre-seed تأخذ 3–6 أشهر للإغلاق.`,
  ...
  return [
    ...
    `معدّل الاحتراق ${burn.toLocaleString("ar-EG-u-nu-latn")} ج/شهر مقبول — ركّز على رفع الإيراد.`,
    `جرّب زيادة الإنفاق التسويقي بنسبة 20% على أنجح قناة — لو CAC < LTV/3، ضاعف.`,
