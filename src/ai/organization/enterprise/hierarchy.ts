...
export const ENTERPRISE_EXECUTIVES: Record<ExecutiveRole, ExecutiveProfile> = {
  ...
  CFO: {
    ...
    department: 'finance',
    directReports: ['budget-analyst', 'cash-runway', 'forecaster', 'investment-advisor'],
  ...
  COO: {
    ...
    directReports: ['operations-manager', 'mistake-shield', 'okr'],
  ...
  CMO: {
    ...
    directReports: ['marketing-strategist', 'brand-builder', 'competitor-intel', 'market-researcher'],
  ...
  CTO: {
    ...
    directReports: ['code-interpreter', 'digital-twin'],
  ...
  CLO: {
    ...
    department: 'legal',
    directReports: ['legal-guide', 'compliance'],
  ...
  CHRO: {
    ...
    department: 'hr',
    directReports: ['hiring-advisor', 'sales-coach'],
  ...
  CSO: {
    ...
    department: 'strategy',
    directReports: ['idea-validator', 'opportunity-radar', 'expansion-planner', 'board-advisor', 'investment-advisor'],
...
export const ENTERPRISE_DEPARTMENTS: Record<DepartmentId, DepartmentProfile> = {
  finance: {
    ...
    head: 'CFO',
    agents: ['cfo-agent', 'forecaster', 'investment-advisor'],
    capabilities: ['financial-analysis', 'forecasting', 'investment', 'cash-flow', 'tax'],
  },
  operations: {
    id: 'operations',
  ...
  marketing: {
    ...
    head: 'CMO',
    agents: ['cmo-agent', 'marketing-strategist', 'brand-builder', 'competitor-intel', 'market-researcher'],
    capabilities: ['brand', 'growth', 'market-research', 'competitor-analysis', 'campaigns'],
  },
  technology: {
    id: 'technology',
    nameAr: 'إدارة التقنية',
    head: 'CTO',
    agents: ['cto-agent', 'code-interpreter', 'digital-twin'],
    capabilities: ['software', 'architecture', 'digital-transformation', 'ai-implementation'],
  },
  legal: {
    id: 'legal',
    nameAr: 'الإدارة القانونية',
    head: 'CLO',
    agents: ['clo-agent', 'legal-guide', 'compliance'],
    capabilities: ['contracts', 'compliance', 'ip', 'regulatory', 'dispute-resolution'],
  },
  hr: {
    id: 'hr',
    nameAr: 'إدارة الموارد البشرية',
    head: 'CHRO',
    agents: ['chro-agent', 'hiring-advisor', 'sales-coach'],
    capabilities: ['recruitment', 'training', 'performance', 'culture', 'compensation'],
  },
  strategy: {
    id: 'strategy',
    nameAr: 'الإدارة الاستراتيجية',
    head: 'CSO',
    agents: ['cso-agent', 'idea-validator', 'opportunity-radar', 'expansion-planner', 'board-advisor'],
    capabilities: ['strategic-planning', 'opportunity-identification', 'expansion', 'investor-relations'],
  },
  sales: {
    id: 'sales',
    ...
    head: 'CMO',
    agents: ['sales-coach'],
    capabilities: ['sales-strategy', 'pipeline', 'customer-acquisition', 'crm'],
  },
  support: {
    id: 'support',
    nameAr: 'خدمة العملاء',
    ...
    capabilities: ['customer-service', 'issue-resolution', 'feedback'],
  },
  monitoring: {
    id: 'monitoring',
